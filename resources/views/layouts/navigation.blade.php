<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-sm border-b border-gray-100 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                            <div>{{ Auth::user()->name }}</div>

                            <div class="ms-1 transform transition-transform duration-300 group-hover:rotate-180">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" class="transform transition-all duration-300 hover:translate-x-1">
                            {{ __('Profile') }}
                        </x-dropdown-link>
